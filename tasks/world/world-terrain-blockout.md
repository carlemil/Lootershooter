...
## Fix
- Install the **Terrain3D** GDExtension (MIT, Godot 4.4+, from the Godot asset library / tokisan.com) into `addons/terrain3d/`; commit the addon but not its build artefacts.
